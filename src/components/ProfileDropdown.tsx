...
// Assurez-vous d'importer vos composants Avatar si vous utilisez shadcn/ui
...
export default function ProfileDropdown({ onOpenUpdateProfile }: ProfileDropdownProps) {
