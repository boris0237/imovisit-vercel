...
export default {
  ...
  signup: {
    ...
    prestataireBio: "I offer my services.",
...
forgotPassword:{
  ...
  subtitle: "Enter the email address associated with your Imovisit account and we'll send you a link to reset your password.",
  email: "Email address",
...
updateProfil :{
  ...
  docCNI : "Identity document (National ID)",
  docDiplome : "Diploma",
  docContribuablle : "Taxpayer card",
  docRCCM : "RCCM extract",
